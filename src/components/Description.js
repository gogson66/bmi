...
function Title() {
    ...
    return (
        <div className="introduction">
            ...
            <FontAwesomeIcon icon={faAngleLeft} className='fas fa-angle-left' id='left' onClick={changeDescription}></FontAwesomeIcon>
            ...
            <FontAwesomeIcon icon={faAngleRight} className='fas fa-angle-right' id='right' onClick={changeDescription}></FontAwesomeIcon>
            </div>
            <div className='circles'>
            <FontAwesomeIcon icon={faCircle} id="0" className={currentDes.index === 0 ? 'active fas fa-circle' : 'fas fa-circle' } onClick={changeDescription}></FontAwesomeIcon>
            <FontAwesomeIcon icon={faCircle} id="1" className={currentDes.index === 1 ? 'active fas fa-circle' : 'fas fa-circle' } onClick={changeDescription}></FontAwesomeIcon>
            <FontAwesomeIcon icon={faCircle} id="2" className={currentDes.index === 2 ? 'active fas fa-circle' : 'fas fa-circle' } onClick={changeDescription}></FontAwesomeIcon>
            </div>
        </div>
    )
}
